...
let sentence: string = "Hello, It's me Suyog Shrestha";
...
let text: string = "Hello, It's me Suyog Shrestha";
...
let longText: string =
  "This is a long sentence that we'll extract the first 10 characters from";
